	...
	public BCryptPasswordEncoder passwordEncoder() { 
	 ...
	 @Bean 
	    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { 
	        http 
	            // 1. Intercept every single request to check if the user was deleted from the DB
	            .addFilterAfter(new OncePerRequestFilter() {
	                ...
	                protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, jakarta.servlet.FilterChain filterChain)
	                    ...
	                    // Skip checks for static assets and public landing pages to prevent infinite redirect loops
	                    ...
	                    if (auth != null && auth.isAuthenticated() && !auth.getPrincipal().equals("anonymousUser")) {
	                        try {
	                            ...
	                            // Catch exception if user was dropped from database, clear context, and kick them out
